...
Included below are the full rulesets for the project's handcrafted agents: Forward Jumping agent, Simple Reactive agent and Complex agent. Blank entries denote a {\footnotesize DONT\_CARE} condition.
